(function() {
    ...
    scheme = c + "://", host =
        ...
        assign: function(a, b, c) {
            ...
            RegExp("\\{" + b +
                ...
                "ig"),
            c);
            else if (typeof d == "object") for (var k in d)
            d.hasOwnProperty(k) && typeof
            d[k] ==
                "string" && (d[k] = d[k].replace(new
            RegExp("\\{" + b +
                "\\}",
                "ig"),
            c))
    ...
    b) {
        return a == null ? !1 : String.prototype.startsWith.call(a,
        b)
    } : function(a, b) {
        return a == null ? !1 : a.toString().indexOf(b) == 0
    },
    endsWith: String.prototype.endsWith ? function(a, b) {
        return a == null ? !1 : String.prototype.endsWith.call(a,
        b)
    } : function(a, b) {
...
function() {
    ...
    "use strict", typeof Date.prototype.toJSON != "function" && (Date.prototype.toJSON = function(a) {
        return
        isFinite(this.valueOf()) ? this.getUTCFullYear() + "-" + f(this.getUTCMonth() + 1) + "-" + f(this.getUTCDate()) +
    ...
    JSON.stringify != "function" && (JSON.stringify = function(a, b, c) {
        ...
        if (!b || typeof b == "function" || typeof b ==
            "object" && typeof b.length == "number") return str("", {
            "": a
        });
        throw new
        ...
        function walk(a, b) {
            var c, d, e = a[b];
            if (e && typeof e == "object") for (c in e)
...
QQWB.provide("man", function(a) {
    return a = this._apiProvider.compat(a),
    this._apiProvider.getDescriptor(a) ? QQWB.JSON.stringify(this._apiProvider.getDescriptor(a)) : "no such api"
}), QQWB.extend("Array", {
    isArray: function(a) {
        return
    ...
    fromString: function(a, b, c) {
        ...
        QQWB.String.isString(a) ? (b = b ||
            "", c ? a.split(b, c) : a.split(b)) : []
    },
    fromArguments: function(a,
    b) {
        return typeof
        a !=
            "object" ? [] : b ? Array.prototype.slice.call(a, b) : Array.prototype.slice.call(a)
    },
    toArray: function(a) {
...
QQWB.extend("dom", {
    ...
    b) {
        ...
        c = document.createElement(a +
            "");
        if (b && c) for (attr in b)
        b.hasOwnProperty(attr) && (QQWB.String.startsWith(attr,
            "data-") ? c.setAttribute(attr,
        b[attr]) : c[attr] = b[attr]);
        return c
    },
    ...
    c) {
        ...
        b);
        return
        c ? (d.width = d.height = 0,
        d.style.width = d.style.height = 0,
        d.style.position =
            "absolute",
        d.style.top =
            "-9999px") : d.style.display =
            "none",
        d
    },
    append: function(a,
    b) {
        return
        b = b || document.body,
        a && a.nodeType && b.appendChild(a),
        this
    },
    html: function(a,
    b) {
        return
        a && a.nodeType && b && (a.innerHTML = b),
        this
    },
    ...
    remove: function(a) {
        return
        a && a.nodeType && a.parentNode && a.parentNode.removeChild(a),
        this
    },
    hasClass: function(a,
    b) {
    ...
    b) {
        return
        b = QQWB.String.trim(b),
        QQWB.Array.isArray(a) ? (QQWB.Array.each(a,
    ...
    b) {
        ...
        this) : (QQWB.dom.hasClass(a,
        b) && (a.className = a.className.replace(b,
            ""),
...
function() {
    ...
    d, e, f) {
        ...
        if (w.length > 1 && j.exec(b)) if (w.length === 2 && i.relative[w[0]]) l = s(w[0] + w[1], d);
            ...
            !f && w.length > 1 && d.nodeType === 9 && !v && i.match.ID.test(w[0]) && !i.match.ID.test(w[w.length - 1]) && (p = h.find(w.shift(), d, v), d = p.expr ? h.filter(p.expr,
            p.set)[0] : p.set[0]);
            if (d) {
                p = f ? {
                    expr: w.pop(),
                ...
                w.length === 1 && (w[0] ===
                    "~" || w[0] ===
                    "+") && d.parentNode ? d.parentNode : d,
                v),
                l = p.expr ? h.filter(p.expr,
                p.set) : p.set,
                w.length > 0 ? n = m(l) : u = !1;
                while (w.length)
                q = w.pop(),
                r = q,
                i.relative[q] ? r = w.pop() : q =
                    "",
                r == null && (r = d),
                i.relative[q](n,
                r,
        ...
        else if (d && d.nodeType === 1) for (t = 0; n[t] != null;
        t++) n[t] && (n[t] === !0 || n[t].nodeType === 1 && h.contains(d,
        n[t])) && e.push(l[t]);
        else for (t = 0;
        n[t] != null;
        t++)
        n[t] && n[t].nodeType === 1 && e.push(l[t]);
        else m(n, e);
        return o && (h(o,
        g,
        e,
        ...
        while (a && b.length) {
            for (var m in i.filter) if ((e = i.leftMatch[m].exec(a)) != null && e[2]) {
                ...
                if (o) {
                    ...
                    var
                    s = d ^ !! n;
                    c && n != null ? s ? f = !0 : k[r] = !1 : s && (j.push(o),
                    f = !0)
                }
                if (n !== undefined) {
                    c || (k = j),
                    a = a.replace(i.match[m],
                        "");
                    if (!f) return [];
                    break
                }
    ...
    var i = h.selectors = {
        ...
        relative: {
            ...
            d) {
                ...
                typeof
                c ==
                    "string" && !g.test(c) && (c = c.toLowerCase(),
                e = c,
                h = q),
                h("parentNode",
                c,
        ...
        preFilter: {
            ...
            g) {
                ...
                h = a[1] = a[1].replace(f,
                    "");
                return !g && i.attrMap[h] && (a[1] = i.attrMap[h]),
                a[4] = (a[4] || a[5] ||
                    "").replace(f,
                    ""),
                a[2] ===
        ...
        filter: {
            ...
            d) {
                ...
                d);
                if (e ===
                    "contains") return (a.textContent || a.innerText || h.getText([a]) ||
                    "").indexOf(b[3]) >= 0;
                if (e ===
                    "not") {
                    var
            ...
            b) {
                return
                b ===
                    "*" && a.nodeType === 1 || a.nodeName.toLowerCase() === b
            },
            CLASS: function(a,
            b) {
                return ("
    ...
    for (var l in i.match)
    i.match[l] = new
    RegExp(i.match[l].source +
        /(?![^\[]*\])(?![^\(]*\))/.source),
    i.leftMatch[l] = new
    RegExp(/(^(?:.|\r|\n)*?)/.source + i.match[l].source.replace(/\\(\d+)/g,
    k));
    var m = function(a,
    b) {
        return
    ...
    try {
        ...
        b) {
            ...
            if (c.call(a) ===
                "[object
														   Array]") Array.prototype.push.apply(e,
            a);
            else if (typeof
            a.length ==
                "number") for (var
    ...
    o,
    p;
    document.documentElement.compareDocumentPosition ? o = function(a,
    b) {
        return
        a === b ? (d = !0,
    ...
    h.getText = function(a) {
        ...
        d++)
        c = a[d],
        c.nodeType === 3 || c.nodeType === 4 ? b += c.nodeValue : c.nodeType !== 8 && (b += h.getText(c.childNodes));
        return
        b
    },
    ...
    function() {
        ...
        c.insertBefore(a,
        c.firstChild),
        document.getElementById(b) && (i.find.ID = function(a,
        b,
        c) {
            if (typeof
            b.getElementById !=
                ...
                d ? d.id === a[1] || typeof
                d.getAttributeNode !=
                    "undefined" && d.getAttributeNode("id").nodeValue === a[1] ? [d] : undefined : []
            }
        },
    ...
    function() {
        ...
        a.getElementsByTagName("*").length > 0 && (i.find.TAG = function(a,
        b) {
            var
    ...
    document.querySelectorAll && function() {
        ...
        f) {
            ...
            if (!f && !h.isXML(d)) {
                ...
                } else if (d.nodeType === 1 && d.nodeName.toLowerCase() !==
                    "object") {
                    var
                    l = d,
                        n = d.getAttribute("id"),
    ...
    document.documentElement.contains ? h.contains = function(a,
    b) {
        return
        a !== b && (a.contains ? a.contains(b) : !0)
    } : document.documentElement.compareDocumentPosition ? h.contains = function(a,
    b) {
...
function() {
    var a = function() {
        ...
        return d.format = function(d, e) {
            ...
            while (b) {
                if ((c =
                    /^[^\x25]+/.exec(b)) !== null) d.push(c[0]);
                else if ((c =
                    /^\x25{2}/.exec(b)) !== null) d.push("%");
                else {
                    if ((c =
                        /^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/.exec(b)) === null) throw "[sprintf]
													    huh?";
                    if (c[2]) {
                        e |= 1;
                        var
                        f = [],
                            ...
                            h = [];
                        if ((h =
                            /^([a-z_][a-z_\d]*)/i.exec(g)) === null) throw "[sprintf]
															    huh?";
                        f.push(h[1]);
                        while ((g = g.substring(h[0].length)) !==
                            "")
                        if ((h =
                            /^\.([a-z_][a-z_\d]*)/i.exec(g)) !== null) f.push(h[1]);
                        else if ((h =
                            /^\[(\d+)\]/.exec(g)) !== null) f.push(h[1]);
                        else throw "[sprintf]
																		    huh?";
                        c[2] = f
                    } else e |= 2;
                    if (e === 3) throw "[sprintf]
													    mixing
													    positional
													    and
													    named
...
QQWB.extend("time", {
    ...
    info: function(a) {
        return this.INFO >= this._level && this._out("INFO",
        a), this
    },
    warning: function(a) {
    ...
    error: function(a) {
        return this.ERROR >= this._level && this._out("ERROR",
        a), this
    },
    critical: function(a) {
        return this.CRITICAL >= this._level && this._out("CRITICAL",
        a),
        this
    },
    _out: function(a,
    b) {
        ...
        this._captureLevel ==
            "number" && this[a] > this._captureLevel && this._capturedMessages && (this._capturedMessages.length >= this._captureMaxSize && this._capturedMessages.shift(),
        this._capturedMessages.push(c)),
        QQWB.debug && window.console && window.console.log(c)
    },
    startCapture: function(a,
    b) {
        return
        this._captureLevel = a || this.NOTSET,
        this._captureMaxSize = b || 50,
    ...
    d, e, f) {
        ...
        1, 1)).toUTCString() : c > 0 && (i = "expires=" + (new Date(+(new
        Date) + c * 1e3)).toUTCString()),
    ...
    del: function(a, b, c) {
        return this.set(a, "",
        0, b, c), document.cookie.indexOf(a + "=") >= 0 && QQWB.log.warning("Cookie
								    may not be
								    deleted as
								    you
								    expected"),
    ...
    stringify: function(a) {
        var b;
        return window.ActiveXObject ? b = a.xml : b = (new
...
QQWB.extend("deferred", {
        ...
        var a = [],
            b, c, d, e = {
                    ...
                    if (!d) {
                        ...
                        b && (g = b, b = 0);
                        for (var
                        h = 0, i = c.length; h < i; h++) f = c[h],
                        QQWB.Array.isArray(f) ? e.done.apply(e, f) : QQWB.Function.isFunction(f) && a.push(f);
    ...
    deferred: function(a) {
        ...
        return QQWB.extend(c, {
            ...
            promise: function(a) {
                ...
                while (d--)
                a[QQWB.deferred._promiseMethods[d]] = c[QQWB.deferred._promiseMethods[d]];
                return
                a
            }
        }), c.success = c.done,
        c.error = c.fail,
        c.complete = c.whatever = c.always,
    ...
    when: function(a) {
        ...
        f(a) {
            ...
            function(c) {
                b[a] = arguments.length > 1 ? QQWB.Array.fromArguments(arguments) : c, --d || e.resolveWith(e,
        ...
        g < c;
        g++)
        b[g] && QQWB.Function.isFunction(b[g].promise) ? b[g].promise().then(f(g),
        e.reject) : --d,
        d || e.resolveWith(e,
        b);
        else e !== a && e.resolveWith(e,
        c ? [a] : []);
        return
        e.promise()
    }
...
QQWB.extend("io", {
    ...
    _IOScript: function(a) {
        ...
        return {
            send: function(e) {
                ...
                g) {
                    if (g || !b.readyState ||
                        /loaded|complete/.test(b.readyState)) clearTimeout(c),
                    b.onload = b.onreadystatechange = null,
                    d && b.parentNode && d.removeChild(b),
                    b = null, !g && e && e.apply(QQWB, [200,
                        "success",
                    QQWB.time.now() - f]),
                    g && e && e.apply(QQWB, [-1,
                        "aborted",
    ...
    _IOAjax: function(a) {
        ...
        a.async || (a.async =
            ...
            send: function(e) {
                var
                f = QQWB.time.now();
                a.username ? d.open(a.type,
                a.url,
                a.async,
                a.username,
                a.password) : d.open(a.type,
                a.url,
                a.async);
                try {
                    a.type ==
                        "POST" && d.setRequestHeader("Content-Type",
                        ...
                        if (b && (h || d.readyState === 4)) {
                            ...
                            if (h) d.readyState !== 4 && d.abort();
                                ...
                                a.dataType.toLowerCase() ==
                                    "json" ? m = QQWB.JSON.fromString(l.text) : a.dataType.toLowerCase() ==
                                    "xml" ? m = l.xml : m = l.text
                            }
                            clearTimeout(c),
                            e(i,
                            j,
            ...
            send: function(e) {
                    ...
                    try {
                        ...
                        g ? e(-1,
                            "request
																			    has
																			    aborted",
                        QQWB.time.now() - f) : (h = this.httpStatus,
                        i = this.httpStatus == 200 ?
                            "ok" :
                            "",
                        j =
                            "",
                        k = {},
                        k.text = this.httpResponseText,
                        a.dataType.toLowerCase() ==
                            "json" ? l = QQWB.JSON.fromString(k.text) : a.dataType.toLowerCase() ==
                            "xml" ? l = QQWB.XML.fromString(k.text) : l = k.text),
                        e(h,
                        i,
                        QQWB.time.now() - f,
                        l,
                ...
                window.onFlashRequestComplete_8df046 || (window.onFlashRequestComplete_8df046 = function(a) {
                    ...
                    b = window.onFlashRequestComplete_8df046.callbacks.getByTicket(a.ticket),
                        c = a.srcEvent;
                    b.readyState || (b.readyState = 0),
                        /httpStatus/i.test(c.type) ? (b.httpStatus = c.status,
                    b.readyState++) :
                        /error/i.test(c.type) ? (b.httpError = c.type,
                    b.readyState++) :
                        /complete/i.test(c.type) && (b.httpResponseText = c.target.data,
                    b.readyState++),
                    b.readyState == 2 && (b.call(b),
                ...
                window.onFlashRequestComplete_8df046.callbacks = {
                    ...
                    register: function(a) {
                        ...
                        b = this._ticketPrefix + this._ticketStartIndex,
                        this._callbackPool[b] = a,
                        b
                    },
                    getByTicket: function(a) {
                        return
                        this._callbackPool[a] || QQWB.log.error("get
																					   callback
																					   failed,
																					   callback
																					   doesn't
                ...
                QQWBFlashTransport && QQWBFlashTransport.httpRequest ? QQWBFlashTransport.httpRequest(a.url,
                a.data,
                a.type,
                window.onFlashRequestComplete_8df046.callbacks.register(b)) : QQWB.log.critical("flash
																	   transportation
																	   object
    ...
    _apiResponder: function(a) {
        ...
        function(b, c, d, e, f, g, h) {
            var i, j;
            b !== 200 ? (b = 2e6 + Math.abs(b ? b : 0), a.reject(b, c, d, "")) : typeof(i = QQWB._apiProvider._apiParseRetCode(f)) == "number" && 0 !== i ? (j = QQWB._apiProvider._apiParseErrorCode(f),
            b = 1e6 + i * 1e3 + 500 + (j ? j : 0), a.reject(b,
            QQWB._apiProvider._apiGetErrorMessage(i,
            j), d,
            f)) : a.resolve(b, c, d, e, g, h)
        }
    },
    ...
    jsonp: function(a) {
        ...
        window[e] = function(a) {
            ...
            h.dataType.toLowerCase() ===
                "json" ? c = QQWB.JSON.fromString(a) : h.dataType.toLowerCase() ===
                "xml" && (c = QQWB.XML.fromString(a)),
            b.resolve(c,
            g),
            window[e] = f
        },
...
QQWB.extend("_token", {
    ...
    exchangeForToken: function(a) {
        ...
        QQWB.io.jsonp({
            ...
            var
            b = a;
            QQWB.String.isString(a) && (a = QQWB.queryString.decode(a)),
            a.access_token ? (!a.expires_in && QQWB.log.error("token
															    expires_in
															    not
															    ...
															    not
															    update
															    username"), !a.wb_nick && QQWB.log.warning("weibo
															    usernick
															    not
															    retrieved,
															    will
            ...
            a.wb_name,
            a.wb_nick),
            a.refresh_token ? QQWB._token.setRefreshToken(a.refresh_token) : QQWB.log.error("refresh
																   token
																   not
																   retrieved"),
            QQWB.log.info("exchange
															   token
															   succeed")) : a.error ? QQWB.log.error("exchange
																	   token
																	   error
																	   " + a.error) : QQWB.log.error("unexpected
																	   result
																	   returned
																	   from
																	   server
    ...
    getNewAccessToken: function(a) {
        ...
        QQWB.io.jsonp({
            ...
            QQWB.log.info("retrieve
																    ...
																    access
																    token
																    succeed")) : a.error ? QQWB.log.error("retrieve
																		    new
																		    access
																		    token
																		    error
    ...
    resolveResponse: function(a,
    b) {
        var
        c,
        d = (b || window).QQWB,
            e = QQWB.String.isString(a) ? d.queryString.decode(a) : a;
        e.access_token ? (d._token.setAccessToken(e.access_token,
        parseInt(e.expires_in,
        10),
        e.wb_name,
        e.wb_nick),
        e.refresh_token ? d._token.setRefreshToken(e.refresh_token) : d.log.error("refresh
														    token
														    not
														    retrieved"),
        c = d.loginStatus(),
        ...
        c)) : e.error ? (d.log.error("login
																		 error
																		 occurred
																		 " + e.error),
        e.message = e.error,
        d.trigger(d.events.USER_LOGIN_FAILED_EVENT,
        e)) : (d.log.error("unexpected
																		 result
																		 returned
																		 from
																		 server
        ...
        i = {
            cookie: function() {
                ...
                if (a && QQWB.browser.webkit) {
                    ...
                    document.cookie = b + "=" + 1 + ";
					    domain=; path=;",
                    document.cookie.indexOf(b) < 0 ? a = !1 : document.cookie = b + "=" + ";
            ...
            flash: function() {
                ...
                navigator.plugins["Shockwave
							     Flash"] ==
                    "object") {
                    var a = navigator.plugins["Shockwave
									     Flash"].description,
                        b = typeof
                        navigator.mimeTypes !=
                            "undefined" && navigator.mimeTypes["application/x-shockwave-flash"] && navigator.mimeTypes["application/x-shockwave-flash"].enabledPlugin;
                    return a && b
                }
                if (typeof
            ...
            postmessage: function() {
                return !!window.postMessage && (QQWB.browser.msie && parseInt(QQWB.browser.version,
                10) < 8 ? !1 : !0)
            },
            canvas: function() {
...
QQWB.extend("_solution", {
    ...
    initSolution: function(a) {
        ...
        this.FLASH_SOLUTION,
        this.SILVER_LIGHT_SOLUTION], a) && (this[a] = {}, this[a].name = a,
        this[a].readyState = 0, this[a].id =
            "solution_" + QQWB.uid(), this[a].deferred = QQWB.deferred.deferred(),
        this[a].promise = this[a].deferred.promise());
        if (this[a] && this[a].readyState !== 0) this[a].deferred.success(function() {
                    ...
                    var d = function(a) {
                        QQWB._domain.serverproxy.indexOf(a.origin) !== 0 ? QQWB.log.warning("unexpected
                            ...
                            "
												     ...
												     data
												     " + a.data) : (a.data ===
                            "success" ? (QQWB.log.info("html5
												     solution
												     was
												     successfully
												     initialized"),
                        b.readyState = 1,
                        b.deferred.resolve()) : QQWB.log.info("unexpected
											      solution
											      signal
											      " + a.data),
                        window.addEventListener ? window.removeEventListener("message",
                        d, !1) : window.attachEvent && window.detachEvent("onmessage",
                        d),
                        d = null)
                    };
                    window.addEventListener ? window.addEventListener("message",
                    d, !1) : window.attachEvent && window.attachEvent("onmessage",
                    d),
            ...
            case
            this.FLASH_SOLUTION:
                QQWB.browser.feature.flash ? (b = this[this.FLASH_SOLUTION],
                QQWB.everythingReady(function() {
                    QQWB.log.info("init
												     flash
												     solution...");
                    ...
                    a,
                    c = 1e4,
                        d = QQWB.flash.load(QQWB._domain.flashproxy,
                        ...
                        function(c) {
                            QQWB.log.info("flash
													     ...
													     successfully"),
                            b.readyState = 1,
                            window.QQWBFlashTransport = QQWB.flash.getSWFObjectByName(c),
                            a && clearTimeout(a),
                            b.deferred.resolve()
                        },
                        QQWB.flash.NO_CACHE);
                    a = setTimeout(function() {
                        b.deferred.isResolved() || (b.readyState = 2,
                        b.deferred.reject(-1,
                            "encounter
												      error
												      while
            ...
            this.SILVER_LIGHT_SOLUTION:
                ...
                QQWB.log.error("sorry,
										     ...
										     is
										     not
										     implemented")) : (QQWB.log.error("can't
									     init
									     solution
									     \"" + a) + "\",browser
							      doesn't support
...
QQWB.extend("ping", {
    ...
    _getBasePingParams: function() {
        var a = QQWB.cookie.get("uin", null,
            "0").match(/\d+/)[0],
            b =
                "";
        return {
    ...
    pingWith: function(a, b) {
        a = QQWB.extend(QQWB.ping._getBasePingParams(),
        a, !0),
        QQWBPingTransport_18035d19 = new
        Image(1, 1),
        QQWBPingTransport_18035d19.src = QQWB.ping._pingbackURL + "?" + QQWB.queryString.encode(a, null,
        null, b)
    },
    pingInit: function() {
        function a() {
            ...
            a = 1e6;
            return feature = 0,
            QQWB.browser.msie ? a += 100 : QQWB.browser.opera ? a += 200 : QQWB.browser.webkit ? a += 300 : QQWB.browser.mozilla ? a += 400 : a += 500,
            QQWB.browser.feature.postmessage && (feature += 1),
            QQWB.browser.feature.flash && (feature += 2),
            QQWB.browser.feature.cookie && (feature += 4), a += feature, a
        }
...
QQWB.extend("", {
    init: function(a) {
        ...
        this.assign("_domain",
            "CLIENTPROXY_URI",
        a.callbackurl), (e || f) && QQWB._tokenReadyDoor.lock(),
        e ? (this.log.info("exchanging
											    refresh
											    token
											    to
											    access
        ...
        QQWB._token.getNewAccessToken(function() {
            ...
            /^[a-z\d][a-z\d]{30}[a-z\d]$/i.test(QQWB.appkey.value) ? this.assign("appkey",
            "APPKEY_VERSION",
        1) :
            /^[1-9][0-9]{7}[0-9]$/.test(QQWB.appkey.value) ? this.assign("appkey",
            "APPKEY_VERSION",
        2) : this.assign("appkey",
            "APPKEY_VERSION",
        3),
        this._inited = !0,
        QQWB._tokenReadyDoor.unlock(),
        this.pingback && this.ping && this.ping.pingInit(),
        this.pingback && this.ping && QQWB.bind(QQWB.events.USER_LOGGEDIN_EVENT,
        this.ping.pingLoggedIn),
        this.pingback && this.ping && QQWB.bind(QQWB.events.USER_LOGIN_FAILED_EVENT,
    ...
    function() {
        this.log.info("tokenReady
												     is
												     unlocked"),
        this._tokenReadyDoor.isOpen() && this.log.info("token
										     is
										     ready") && this.trigger(this.events.TOKEN_READY_EVENT)
    }),
    tokenReady: function(a) {
        return
        this._tokenReadyDoor.isOpen() ? a && a() : this.bind(this.events.TOKEN_READY_EVENT,
        a),
        this
    },
    _isDocumentReady: !1,
    ...
    documentReady: function(a) {
        return
        this._isDocumentReady ? a && a() : (this.bind(this.events.DOCUMENT_READY_EVENT,
        a),
    ...
    function() {
        this.log.info("everythingReady
												     is
												     unlocked"),
        this._everythingReadyDoor.isOpen() && this.log.info("everything
										     is
										     ready") && this.trigger(this.events.EVERYTHING_READY_EVENT)
    }),
    everythingReady: function(a) {
        return
        this._everythingReadyDoor.isOpen() ? a && a() : this.bind(this.events.EVERYTHING_READY_EVENT,
        a),
        this
    }
}),
...
function() {
    function c() {
        QQWB.browser.feature.postmessage ? QQWB._solution.initSolution(QQWB._solution.HTML5_SOLUTION) : QQWB.browser.feature.flash ? QQWB._solution.initSolution(QQWB._solution.FLASH_SOLUTION) : QQWB.log.error("init solution is called, but no
					solution for the browser")
    }
    ...
    if (a && b && QQWB.browser.feature.postmessage) {
        ...
        var f = function(a) {
            var b = QQWB.JSON.fromString(a.data),
                ...
                f = b.data,
                g = f[0];
            f[2].toLowerCase() == "xml" && (f[2] = "xmltext"), g ? QQWB.io._apiAjax.apply(this,
            f).complete(function() {
        ...
        window.addEventListener ? window.addEventListener("message",
        f, !1) : window.attachEvent && window.attachEvent("onmessage",
        f);
        return
    }
...
QQWB._isDocumentReady || (window.addEventListener && document.addEventListener("DOMContentLoaded",

function() {
    QQWB._tryToTriggerDocumentReadyEvents()
}, !1),
window.attachEvent && (document.attachEvent("onreadystatechange",

function() {
    /complete/.test(document.readyState) && (document.detachEvent("onreadystatechange",
    arguments.callee),
    QQWB._tryToTriggerDocumentReadyEvents())
}),
    ...
    function b() {
        ...
        a && QQWB.log.info("cancel
												...
												**OLD**
												...
												schedule"),
        a && clearTimeout(a),
        c ? (d = parseInt(QQWB.cookie.get(QQWB._cookie.names.accessToken).split("|")[1],
        10) - QQWB.time.now() - 15e3,
...
if (QQWB.browser.feature.localstorage) QQWB.extend("localStorage", {
    ...
    QQWB.documentReady(function() {
        userData = document.createElement("input"), userData.type = "hidden",
        userData.style.display = "none",
        userData.addBehavior("#default#userData"), userData.expires = (new Date(QQWB.time.now() + 31536e7)).toUTCString(),
    ...
    QQWB.extend("localStorage", {
        set: function(a, b, c) {
            ...
            return !userData && QQWB.log.error("store can't set value for key " + a +
                ", userData is unavaiable, please try later"),
            userData && userData.load(storeName), userData && userData.setAttribute(a, JSON.stringify(e)), userData && userData.save(storeName), userData.getAttribute(a)
        },
        get: function(a, b) {
            a = "k" + a, !userData && QQWB.log.error("store can't get value for key " + a +
                ", userData is unavaiable, please try later"),
        ...
        del: function(a) {
            return a = "k" + a, !userData && QQWB.log.error("store can't delete value for
					key " + a + ", userData is unavaiable,
					please try later"), userData && userData.load(storeName), userData && userData.removeAttribute(a), userData && userData.save(storeName), !userData.getAttribute(a)
        }
    })
} else QQWB.log.warning("T.localStorage object isn't
			initialized, do check before use");
QQWB.localStorage && (QQWB._alias.call(QQWB.localStorage, "save",
...
QQWB.extend("auth.authWindow", {
    ...
    show: function() {
        ...
        return this._authorizing ? this.focus() : (a = (window.screenX || window.screenLeft) + ((window.outerWidth || document.documentElement.clientWidth) - this._width) / 2, b = (window.screenY || window.screenTop) + ((window.outerHeight || document.documentElement.clientHeight) - this._height) / 2, c = QQWB.queryString.encode({
            ...
            scope: "all",
            status: 0
        }), d = ["width=" + this._width, "height=" + this._height, "left=" + a, "top=" + b], this._window = window.open(this._url + "?" + c, this._name, d + "," + this._attribs),
        this._authorizing = !0, function() {
            ...
            if (b) {
                b = QQWB.queryString.decode(b.split("#").pop()),
                parseInt(b.status, 10) == 200 && QQWB._token.resolveResponse(b),
                a.close();
                return
            }
    ...
    close: function() {
        ...
        this._window ? this._window.closed ? this : (this._window.close(),
        this) : this
    },
    focus: function() {
    ...
    login: function(a, b) {
        ...
        if (a || b) d = function(c) {
            c.access_token && a ? a(c) : c.error && b ? b(c) : QQWB.log.warning("confused result
				of T.login"),
    ...
    logout: function(a) {
        ...
        return
        QQWB.log.info("logging out user..."), b ? (QQWB._token.clearAccessToken(),
        QQWB._token.clearRefreshToken(), QQWB.log.info(b.name + " has logged out successfully")) : QQWB.log.warning("oops, user not logged in"), a && a.call(QQWB),
...
QQWB.provide("api", function(a, b, c, d, e) {
    a = this._apiProvider.compat(a), b = b || {}, c = (c ||
    ...
    h in i || (h = "json"),
    b.oauth_consumer_key = QQWB.appkey.value, b.oauth_token = QQWB._token.getAccessToken(), b.oauth_version = "2.0",
    b.format = h, f = j.promise(), e && QQWB.Array.inArray([QQWB._solution.HTML5_SOLUTION,
    QQWB._solution.FLASH_SOLUTION,
    QQWB._solution.SILVER_LIGHT_SOLUTION], e) ? (QQWB.log.warning("forced to use solution " + e),
    QQWB._solution[e] || (QQWB.log.warning("forced to use
					 solution " + e + ", this solution is
					 not inited, initialzing..."),
    QQWB._solution.initSolution[e]), g = QQWB._solution[e]) : g = QQWB.browser.feature.postmessage && QQWB._solution[QQWB._solution.HTML5_SOLUTION] || QQWB.browser.feature.flash && QQWB._solution[QQWB._solution.FLASH_SOLUTION] || QQWB.browser.feature.silverlight && QQWB._solution[QQWB._solution.SILVER_LIGHT_SOLUTION];
    ...
    }), QQWB.api.id++, QQWB.log.info("[" + QQWB.api.id + '] requesting data "' + QQWB._apiProvider.describe(a) + '" from
				server...');
    if (g === QQWB._solution[QQWB._solution.HTML5_SOLUTION]) {
        ...
        0);
            ...
            }), QQWB.api.messageHandler || (QQWB.provide("api.messageHandler",
            ...
            function(a) {
                if (QQWB._domain.serverproxy.indexOf(a.origin) !== 0) QQWB.log.warning("unexpected
                    ...
                    b = QQWB.JSON.fromString(a.data),
                        ...
                        e = b.data;
                    d ? (e[0] !== 200 ? d.reject.apply(d,
                    e) : (e[5] ==
                        "xmltext" && (e[3] = QQWB.XML.fromString(e[3])),
                    d.resolve(e[3],
                    e[2],
                    e[4])),
                    QQWB.api.uncollect(c)) : QQWB.log.warning("related
													      deferred
													      object
													      not
													      found,
            ...
            window.addEventListener ? window.addEventListener("message",
            QQWB.api.messageHandler, !1) : window.attachEvent && window.attachEvent("onmessage",
